...
void SetClientVolumeFuzzTest()
{
    ...
    auto hpaeGainNode = std::make_shared<HpaeGainNode>(nodeInfo);
    float gain = GetData<float>();
    hpaeGainNode->SetClientVolume(gain);
}

void GetClientVolumeFuzzTest()
{
    HpaeNodeInfo nodeInfo;
    GetTestNodeInfo(nodeInfo);
    auto hpaeGainNode = std::make_shared<HpaeGainNode>(nodeInfo);    
...
TestFuncs g_testFuncs = {
    ...
    GetClientVolumeFuzzTest,
    SetFadeStateFuzzTest,
};
