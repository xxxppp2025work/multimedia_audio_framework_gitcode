...
void AudioDeviceFuzzTest(const uint8_t *rawData, size_t size)
{
    ...
    const std::shared_ptr<AudioStandard::AudioDeviceDescriptor> deviceDescriptor = std::make_shared<AudioStandard::AudioDeviceDescriptor>();
...
void AudioPolicyOtherFuzzTest(const uint8_t *rawData, size_t size)
{
    ...
    std::shared_ptr<AudioStandard::AudioDeviceDescriptor> deviceDescriptor = std::make_shared<AudioStandard::AudioDeviceDescriptor>();
