...
void AudioPolicyServiceTestII()
{
    ...
    GetServerPtr()->
        audioPolicyService_.FetchInputDevice(audioCapturerChangeInfos, reason);
...
void AudioPolicyServiceTestIII()
{
    ...
    GetServerPtr()->audioPolicyService_.ScoInputDeviceFetchedForRecongnition(handleFlag, NETWORKID, connectState);
    ...
    InternalDeviceType internalDeviceType = DEVICE_TYPE_BLUETOOTH_A2DP;
    GetServerPtr()->audioPolicyService_.IsA2dpOrArmUsbDevice(internalDeviceType);
    GetServerPtr()->audioPolicyService_.IsRingerOrAlarmerDualDevicesRange(internalDeviceType);
    ...
    GetServerPtr()->audioPolicyService_.
        HandleRecoveryPreferredDevices(A2DP_PLAYING, usageOrSourceType, usageOrSourceType);
    GetServerPtr()->audioPolicyService_.RestoreSession(usageOrSourceType, handleFlag);
}
...
void AudioPolicyServiceTestIV()
{
    ...
    GetServerPtr()->audioPolicyService_.
        ActivateA2dpDevice(adc, audioRendererChangeInfos, reason);
}
