...
std::unordered_map<std::string, DeviceType> AudioDefinitionPolicyUtils::deviceNameToTypeEnum = {
    {"Speaker_Out", DEVICE_TYPE_SPEAKER},
    {"Bt_A2DP_Out", DEVICE_TYPE_BLUETOOTH_A2DP},
    {"Builtin_Mic_In", DEVICE_TYPE_MIC},
    {"Built_in_wakeup", DEVICE_TYPE_WAKEUP},
    {"Hdmi_Out", DEVICE_TYPE_HDMI},
    {"Line_Digital", DEVICE_TYPE_LINE_DIGITAL},
    {"Usb_Arm_Speaker_In", DEVICE_TYPE_USB_ARM_HEADSET},
};
