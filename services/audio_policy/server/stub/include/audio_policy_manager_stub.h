...
private:
    ...
    void HandleAddStreamUsageToAudioZone(MessageParcel &data, MessageParcel &reply);
    void HandleRemoveStreamUsageFromAudioZone(MessageParcel &data, MessageParcel &reply);
