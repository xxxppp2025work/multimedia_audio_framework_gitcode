...
static const int32_t DATASHARE_SERVICE_TIMEOUT_TEN_SECONDS = 10; // 10s is better
...
int32_t AudioPolicyServer::CallRingtoneLibrary()
{
    ...
    AudioXCollie audioXCollie("CallRingtoneLibrary::start", DATASHARE_SERVICE_TIMEOUT_TEN_SECONDS,
        [](void *) {
    ...
    auto dataShareHelper = DataShare::DataShareHelper::Creator(remoteObj, "datashare:///ringtone", "",
        DATASHARE_SERVICE_TIMEOUT_TEN_SECONDS);
