...
public:
    ...
    bool GetMuteStatusWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType);
    bool SaveMuteStatusWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType,
        bool muteStatus);
    bool GetVolumeWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType);
    bool SaveVolumeWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType,
        int32_t volumeLevel);
