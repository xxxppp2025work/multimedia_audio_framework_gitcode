...
bool VolumeDataMaintainer::SaveVolumeWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType,
    int32_t volumeLevel)
{
...
bool VolumeDataMaintainer::GetVolumeWithDatabaseVolumeName(std::string databaseVolumeName, AudioStreamType streamType)
{
    ...
    AUDIO_INFO_LOG("Get Volume: volumeKey [%{public}s], volumeLevel [%{public}d]",
        volumeKey.c_str(), volumeLevel);
    return true;
}

bool VolumeDataMaintainer::SaveMuteStatusWithDatabaseVolumeName(std::string databaseVolumeName,
...
bool VolumeDataMaintainer::GetMuteStatusWithDatabaseVolumeName(std::string databaseVolumeName,
    AudioStreamType streamType)
{
    ...
    ErrCode ret = audioSettingProvider.GetIntValue(muteKey, muteStatus, "system");
    if (ret != SUCCESS) {
