...
VolumeBehavior AudioDeviceManager::GetVolumeBehavior(const std::string &networkId, DeviceType deviceType)
{
    AUDIO_INFO_LOG("GetVolumeBehavior: networkId [%{public}s], deviceType [%{public}d]",
