...
*/
HWTEST_F(AudioDeviceCommonUnitNextTest, ScoInputDeviceFetchedForRecongnition_001, TestSize.Level4)
{
    AudioDeviceCommon& audioDeviceCommon = AudioDeviceCommon::GetInstance();
    audioDeviceCommon.DeInit();
...
* @tc.desc  : Test ScoInputDeviceFetchedForRecongnition interface.
*/
HWTEST_F(AudioDeviceCommonUnitNextTest, ScoInputDeviceFetchedForRecongnition_002, TestSize.Level4)
{
    AudioDeviceCommon& audioDeviceCommon = AudioDeviceCommon::GetInstance();
    audioDeviceCommon.DeInit();
