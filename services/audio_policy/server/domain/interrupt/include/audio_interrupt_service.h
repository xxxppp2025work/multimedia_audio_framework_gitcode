...
public:
    ...
    std::vetor<int32_t> GetAudioSessionUidList(int32_t zoneId);
...
private:
    ...
    void HandleAppStreamType(AudioInterrupt &audioInterrupt, const int32_t zondId);
    ...
    bool ShouldBypassAudioSessionFocus(const AudioInterrupt &incomingInterrupt, const int32_t zondId);
