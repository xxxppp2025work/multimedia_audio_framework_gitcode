...
private:
    ...
    void HandleAppStreamType(AudioInterrupt &audioInterrupt, const int32_t zoneId);
    ...
    bool ShouldBypassAudioSessionFocus(const AudioInterrupt &incomingInterrupt, const int32_t zoneId);
