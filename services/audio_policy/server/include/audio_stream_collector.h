...
public:
    ...
    int32_t UpdateRendererDeviceInfo(int32_t clientUID, int32_t streamId, AudioDeviceDescriptor &outputDeviceInfo);
    int32_t UpdateRendererDeviceInfo(std::shared_ptr<AudioDeviceDescriptor> outputDeviceInfo);
    int32_t UpdateRendererPipeInfo(const int32_t streamId, const AudioPipeType pipeType);
    int32_t UpdateCapturerDeviceInfo(int32_t clientUID, int32_t streamId, AudioDeviceDescriptor &inputDeviceInfo);
    ...
    bool CheckVoiceCallActive(int32_t streamId);
    ...
    bool IsOffloadAllowed(const int32_t streamId);
    ...
    AudioStreamType GetStreamType(int32_t streamId);
    int32_t GetChannelCount(int32_t streamId);
    ...
    int32_t GetPipeType(const int32_t streamId, AudioPipeType &pipeType);
    bool ExistStreamForPipe(AudioPipeType pipeType);
    int32_t GetRendererDeviceInfo(const int32_t streamId, AudioDeviceDescriptor &outputDeviceInfo);
