...
public:
    ...
    std::string GetSinkName(const AudioDeviceDescriptor &desc, int32_t streamId);
    std::string GetSinkName(std::shared_ptr<AudioDeviceDescriptor> desc, int32_t streamId);
