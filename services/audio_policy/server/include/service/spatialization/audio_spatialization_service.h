...
public:
    ...
    void HandleSpatializationEnabledChange(const std::shared_ptr<AudioDeviceDescriptor> &selectedAudioDevice, const bool &enabled);
    void HandleHeadTrackingEnabledChange(const bool &enabled);
    void HandleHeadTrackingEnabledChange(const std::shared_ptr<AudioDeviceDescriptor> &selectedAudioDevice, const bool &enabled);
