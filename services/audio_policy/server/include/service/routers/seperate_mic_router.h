...
#ifndef SEPERATE_MIC_ROUTER_H
#define SEPERATE_MIC_ROUTER_H

#include "router_base.h"

namespace OHOS {
namespace AudioStandard {
class SeperateMicRouter : public RouterBase {
public:
    SeperateMicRouter();
    ~SeperateMicRouter();
    ...
    vector<std::shared_ptr<AudioDeviceDescriptor>> GetRingRenderDevices(StreamUsage streamUsage, int32_t clientUID) override;
