 ...
 */
 ...
 #ifndef ST_SEPERATE_MIC_ROUTER_H
 #define ST_SEPERATE_MIC_ROUTER_H
 ...
 private:
     void SortDevicesByConnectTime(vector<shared_ptr<AudioDeviceDescriptor>>& descs);
 
  };
  } // namespace AudioStandard
  } // namespace OHOS
  #endif // ST_SEPERATE_MIC_ROUTER_H