...
public:
    ...
    void StoreToTmpVolumeLevelMap(void);
    void LoadFromTmpVolumeLevelMap(void);
...
private:
    ...
    std::unordered_map<AudioStreamType, int32_t> tmpVolumeLevelMap_; // save system tmp volume map
