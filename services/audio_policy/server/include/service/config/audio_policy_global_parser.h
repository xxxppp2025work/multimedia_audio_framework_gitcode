...
public:
    static constexpr char POLICY_GLOBAL_CHIP_CONFIG_FILE[] = "/chip_prod/etc/audio/audio_policy_global_config.xml";
    static constexpr char POLICY_GLOBAL_CONFIG_FILE[] = "/vendor/etc/audio/audio_policy_global_config.xml";
