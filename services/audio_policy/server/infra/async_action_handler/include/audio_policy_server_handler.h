...
private:
    ...
    std::vector<std::pair<AudioRendererInfo, int32_t> GetCallbackRendererInfoList(int32_t clientPid);
    ...
    int32_t pidOfRss_ = -1;
    std::unordered_map<int32_t, std::vector<std::pair<AudioRendererInfo, int32_t>>> clientCbRendererInfoMap_;
