...
void MicPhoneBlocked::OnMicrophoneBlocked(const std::string &info, AudioPnpServer &audioPnpServer)
{
...
void AudioPnpServer::OpenAndReadInput()
{
    ...
    do {
        ...
        if (AudioSocketThread::audioSocketEvent_.eventType == PNP_EVENT_MIC_BLOCKED ||
            AudioSocketThread::audioSocketEvent_.eventType == PNP_EVENT_MIC_UN_BLOCKED) {
