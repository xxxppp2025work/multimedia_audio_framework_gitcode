...
void AudioAdapterManager::SetDevicetoSafeVolume()
{
    if (handler_ == nullptr) {
    ...
    bool isTimeout = safeStatusBt + safeStatus >= ONE_MINUTE * GetSafeVolumeTimeout() ? true : false;
    switch (currentActiveDevice_) {
        case DEVICE_TYPE_WIRED_HEADSET:
        case DEVICE_TYPE_WIRED_HEADPHONES:
        case DEVICE_TYPE_USB_HEADSET:
        case DEVICE_TYPE_USB_ARM_HEADSET:
            if (volumeDataMaintainer_.GetDeviceVolume(DEVICE_TYPE_BLUETOOTH_A2DP) > safeVolume_ &&
                isTimeout && safeStatusBt == SAFE_ACTIVE) {
        ...
        case DEVICE_TYPE_BLUETOOTH_A2DP:
            if (volumeDataMaintainer_.GetDeviceVolume(DEVICE_TYPE_WIRED_HEADSET) > safeVolume_ &&
                isTimeout && safeStatusBt == SAFE_ACTIVE) {
