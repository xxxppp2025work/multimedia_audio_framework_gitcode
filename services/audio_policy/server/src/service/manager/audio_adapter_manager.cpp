...
bool AudioAdapterManager::Init()
{
    ...
    auto loadret = audiovolumeParser->LoadConfig(streamVolumeInfos_);
...
std::vector<AudioStreamType> AudioAdapterManager::GetVolumeTypeList() const
{
    return defaultVolumeTypeList_;
}
