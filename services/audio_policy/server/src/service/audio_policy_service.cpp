...
int32_t AudioPolicyService::NofitySessionStateChange(const int32_t uid, const int32_t pid, bool hasSession)
{
    return audioBackgroundManager_.NofitySessionStateChange(uid, pid, hasSession);
}
}

int32_t AudioPolicyService::NotifyFreezeStateChange(const std::set<int32_t> &pidList, bool isFreeze)
{
...
{
    return audioBackgroundManager_.IsAllowPlayback(uid, pid);
}
