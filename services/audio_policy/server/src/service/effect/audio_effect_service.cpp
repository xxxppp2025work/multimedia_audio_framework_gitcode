...
void AudioEffectService::EffectManagerInit()
{
    AUDIO_INFO_LOG("In");
    // load XML
...
void AudioEffectService::AddSupportedPropertyByDeviceInner(const DeviceType& deviceType,
...
void AudioEffectService::AddSupportedAudioEffectPropertyByDevice(const DeviceType &deviceType,
    std::set<std::pair<std::string, std::string>> &mergedSet)
{
    return AddSupportedPropertyByDeviceInner(deviceType, mergedSet, device2EffectPropertySet_);
}

void AudioEffectService::AddSupportedAudioEnhancePropertyByDevice(const DeviceType &deviceType,
    std::set<std::pair<std::string, std::string>> &mergedSet)
{
