...
bool AudioDeviceCommon::IsRingerOverPlayback(AudioMode &mode, RendererState rendererState)
{
    ...
    RendererState rendererState)
{
    ...
    if (isRingDualToneOnPrimarySpeaker_ && IsRingerOverPlayback(mode, rendererState) &&
