...
void AudioVolumeManager::SetVolumeForSwitchDevice(AudioDeviceDescriptor deviceDescriptor, const std::string &newSinkName)
{
...
void AudioVolumeManager::SetMaxVolumeForDeviceUpdate()
{
    audioPolicyManager_.SetMaxVolumeForDeviceUpdate();
}
