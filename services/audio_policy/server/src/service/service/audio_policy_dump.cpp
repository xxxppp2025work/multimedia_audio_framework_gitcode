...
void AudioPolicyDump::GetAdjustVolumeDump(std::string &dumpString)
{
    ...
    adjustStreamVolumeInfo = audioVolumeManager_.GetStreamVolumeInfo();
    AdjustVolumeAppend(adjustStreamVolumeInfo, dumpString);

    dumpString += "\nSetLowPowerVolume Info:\n";
    adjustStreamVolumeInfo = audioVolumeManager_.GetLowPowerVolumeInfo();
    AdjustVolumeAppend(adjustStreamVolumeInfo, dumpString);

    dumpString += "\nSetDuckVolume Info:\n";
    adjustStreamVolumeInfo = audioVolumeManager_.GetDuckVolumeInfo();
    AdjustVolumeAppend(adjustStreamVolumeInfo, dumpString);
}
