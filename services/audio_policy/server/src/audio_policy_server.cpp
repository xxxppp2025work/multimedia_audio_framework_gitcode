...
int32_t AudioPolicyServer::RegisterVolumeKeyEvents(const int32_t keyType)
{
    ...
    audioPolicyService_.SaveVolumeKeyRegistrationInfo(
        keyType == OHOS::MMI::KeyEvent::KEYCODE_VOLUME_UP ? "Volume Up" : "Volume Down", GetTime(),
...
int32_t AudioPolicyServer::RegisterVolumeKeyMuteEvents()
{
    ...
    audioPolicyService_.SaveVolumeKeyRegistrationInfo(keyType, GetTime(),
    ...
    bool mute)
{
    ...
    if (ret == SUCCESS) {
        audioPolicyService_.SaveSystemVolumeLevelInfo(streamType, volumeLevel, GetBundleName(), GetTime());
...
int32_t AudioPolicyServer::SetRingerMode(AudioRingerMode ringMode)
{
    ...
    if (result == SUCCESS) {
        audioPolicyService_.SaveRingerModeInfo(ringMode, GetBundleName(), GetTime());
    }
    return result;
}
