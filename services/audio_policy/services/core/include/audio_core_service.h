...
private:
    ...
    int32_t SelectOutputDeviceAndRoute(
        const AudioStreamDeviceChangeReasonExt reason = AudioStreamDeviceChangeReason::UNKNOWN);
...
private:
    ...
    int32_t SelectDeviceAndRoute(
        const AudioStreamDeviceChangeReasonExt reason = AudioStreamDeviceChangeReason::UNKNOWN);
    int32_t FetchOutputDevice(
    ...
    int32_t FetchOutputDevices(std::vector<std::shared_ptr<AudioStreamDescriptor>> &outputStreamDescs,
    ...
    int32_t FetchPipesAndExecute(
        std::vector<AudioStreamDescriptor> &outputStreamDescs, const AudioStreamDeviceChangeReasonExt reason);
