...
public:
    ...
    public:
        ...
        int32_t SetDeviceActive(InternalDeviceType deviceType, bool active, const int32_t uid);
        int32_t SetCallDeviceActive(InternalDeviceType deviceType, bool active, std::string address, const int32_t uid);
