...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_119
* @tc.desc  : Test SetAdjustVolumeForZone
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_119, TestSize.Level1)
{
...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_120
* @tc.desc  : Test SetSharedVolume interface.
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_120, TestSize.Level1)
{
    auto audioVolumeManager = std::make_shared<AudioVolumeManager>();
    ...
    audioVolumeManager->volumeVector_ = new Volume();
    ret = audioVolumeManager->SetSharedVolume(streamType, deviceType, vol);
    EXPECT_EQ(ret, true);
    delete audioVolumeManager->volumeVector_;
    audioVolumeManager->volumeVector_ = nullptr;
}
...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_121
* @tc.desc  : Test SetSharedVolume interface.
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_121, TestSize.Level1)
{
    auto audioVolumeManager = std::make_shared<AudioVolumeManager>();
    ASSERT_TRUE(audioVolumeManager != nullptr);
...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_122
* @tc.desc  : Test SetSharedVolume interface.
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_122, TestSize.Level1)
{
    auto audioVolumeManager = std::make_shared<AudioVolumeManager>();
    ASSERT_TRUE(audioVolumeManager != nullptr);
...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_123
* @tc.desc  : Test AudioVolumeManager.
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_123, TestSize.Level1)
{
    auto audioVolumeManager = std::make_shared<AudioVolumeManager>();
    EXPECT_NE(audioVolumeManager, nullptr);
...
/**
* @tc.name  : Test AudioVolumeManager.
* @tc.number: AudioVolumeManager_124
* @tc.desc  : Test AudioVolumeManager.
*/
HWTEST_F(AudioVolumeManagerUnitTest, AudioVolumeManager_124, TestSize.Level1)
{
    auto audioVolumeManager = std::make_shared<AudioVolumeManager>();
    EXPECT_NE(audioVolumeManager, nullptr);
