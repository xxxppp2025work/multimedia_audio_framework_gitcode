 ...
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_001, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), Config(testing::_, testing::_, testing::_)).WillRepeatedly(Return(SUCCESS));
 ...
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_002, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillRepeatedly(Return(false));
 ...
 * @tc.desc  : Test ParseInternal interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_003, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillRepeatedly(Return(false));
 ...
 * @tc.desc  : Test ParseInternal interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_004, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillRepeatedly(Return(false));
 ...
 * @tc.desc  : Test ParseInternal interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_005, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillRepeatedly(Return(false));
 ...
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_006, TestSize.Level1)
{
 ...
 * @tc.desc  : Test ParserAffinityGroups interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_007, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
 ...
 * @tc.desc  : Test ParserAffinityGroups interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_008, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
 ...
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_009, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
 ...
 * @tc.desc  : Test ParserAffinityGroupAttribute interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_010, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
 ...
 * @tc.desc  : Test ParserAffinityGroupAttribute interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_011, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
    ...
    EXPECT_CALL(*(mockAudioXmlNode_), GetProp(testing::_, testing::_)).WillRepeatedly(Return(ERROR));
    EXPECT_CALL(*(mockAudioXmlNode_), GetCopyNode()).WillOnce(Return(mockAudioXmlNode_));
 ...
 * @tc.desc  : Test ParserAffinityGroupAttribute interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_012, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
 ...
 * @tc.desc  : Test ParserAffinityGroupAttribute interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_013, TestSize.Level1)
{
    DeviceFlag deviceFlag = INPUT_DEVICES_FLAG;
 ...
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_014, TestSize.Level1)
{
 ...
 * @tc.desc  : Test ParserAffinityGroupDeviceInfos interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_015, TestSize.Level1)
{
     AffinityDeviceInfo deviceInfo;
 ...
 * @tc.desc  : Test ParserAffinityGroupDeviceInfos interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_016, TestSize.Level1)
{
     AffinityDeviceInfo deviceInfo;
 ...
 * @tc.desc  : Test ParserAffinityGroupDeviceInfos interface.
 */
HWTEST_F(AudioAffinityParserUnitTest, AudioAffinityParserUnitTest_017, TestSize.Level1)
{
     AffinityDeviceInfo deviceInfo;
