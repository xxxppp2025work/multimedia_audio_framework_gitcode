...
*/
HWTEST_F(AudioPolicyServiceExtendedUnitTest, ClearAudioFocusBySessionID, TestSize.Level1)
{
    uint32_t sessionId = 0;
...
*/
HWTEST_F(AudioPolicyServiceExtendedUnitTest, SetSleAudioOperationCallback, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServiceExtendedUnitTest, OnDeviceInfoUpdated, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServiceExtendedUnitTest, SubscribeAccessibilityConfigObserver, TestSize.Level1)
{
