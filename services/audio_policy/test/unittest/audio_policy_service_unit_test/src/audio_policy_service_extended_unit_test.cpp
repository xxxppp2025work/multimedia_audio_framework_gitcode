...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, RestoreSession_001, TestSize.Level1)
{
    ...
    RestoreInfo restoreInfo;
    EXPECT_NO_THROW(
        AudioPolicyService::GetAudioPolicyService().RestoreSession(testID, restoreInfo);
    );
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, GetDistributedRoutingRoleInfo_001, TestSize.Level1)
{
    ...
    GetPermission();
    EXPECT_NO_THROW(
        AudioPolicyService::GetAudioPolicyService().GetDistributedRoutingRoleInfo();
    );
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, GetFastStreamInfo_001, TestSize.Level1)
{
    ...
    GetPermission();
    AudioPolicyService::GetAudioPolicyService().audioConfigManager_.OnFastFormatParsed(AudioSampleFormat::SAMPLE_S32LE);
    auto res = AudioPolicyService::GetAudioPolicyService().GetFastStreamInfo();
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, GetActiveOutputDeviceDescriptor_001, TestSize.Level1)
{
    ...
    GetPermission();
    auto res = AudioPolicyService::GetAudioPolicyService().GetActiveOutputDeviceDescriptor();
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, OnMicrophoneBlockedUpdate_001, TestSize.Level1)
{
    ...
    GetPermission();
    EXPECT_NO_THROW(
        AudioPolicyService::GetAudioPolicyService().OnMicrophoneBlockedUpdate(DeviceType::DEVICE_TYPE_EARPIECE,
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, OnMicrophoneBlockedUpdate_002, TestSize.Level1)
{
    ...
    GetPermission();
    EXPECT_NO_THROW(
        AudioPolicyService::GetAudioPolicyService().OnMicrophoneBlockedUpdate(DeviceType::DEVICE_TYPE_NONE,
            DeviceBlockStatus::DEVICE_BLOCKED);
    );
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, SetAvailableDeviceChangeCallback_002, TestSize.Level1)
{
    ...
    int32_t ret = AudioPolicyService::GetAudioPolicyService().SetAvailableDeviceChangeCallback(clientId,
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, SetQueryClientTypeCallback_001, TestSize.Level1)
{
    ...
    int32_t ret = AudioPolicyService::GetAudioPolicyService().SetQueryClientTypeCallback(object);
    ASSERT_EQ(SUCCESS, ret);
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, UpdateDescWhenNoBTPermission_001, TestSize.Level1)
{
    ...
    EXPECT_NO_THROW(
        AudioPolicyService::GetAudioPolicyService().UpdateDescWhenNoBTPermission(devices);
    );
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, UpdateCapturerInfoWhenNoPermission_001, TestSize.Level1)
{
    ...
    auto &server = AudioPolicyService::GetAudioPolicyService();
    ...
    int32_t ret = server.GetCurrentCapturerChangeInfos(audioCapturerChangeInfos, hasBTPermission,
        hasSystemPermission);
    EXPECT_EQ(ret, SUCCESS);
}
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, GetPreferredOutputStreamType_002, TestSize.Level1)
{
    ...
    int32_t ret = server.GetPreferredOutputStreamType(rendererInfo, bundleName);
...
HWTEST_F(AudioPolicyServiceExtendedUnitTest, GetHardwareOutputSamplingRate_001, TestSize.Level1)
{
    ...
    int32_t ret = server.GetHardwareOutputSamplingRate(desc);
    EXPECT_EQ(ret, -1);

    desc = std::make_shared<AudioDeviceDescriptor>();
    desc->deviceRole_ = DeviceRole::DEVICE_ROLE_NONE;
    ret = server.GetHardwareOutputSamplingRate(desc);
    EXPECT_EQ(ret, -1);
