...
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, RestoreSession_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest RestoreSession_001 start");
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetDistributedRoutingRoleInfo_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest GetDistributedRoutingRoleInfo_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetFastStreamInfo_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest GetFastStreamInfo_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetFastStreamInfo_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest GetFastStreamInfo_002 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    auto res = GetServerPtr()->audioPolicyService_.GetFastStreamInfo();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetActiveOutputDeviceDescriptor_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest GetActiveOutputDeviceDescriptor_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, OnMicrophoneBlockedUpdate_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest OnMicrophoneBlockedUpdate_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, OnMicrophoneBlockedUpdate_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest OnMicrophoneBlockedUpdate_002 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetAllSinkInputs_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest GetAllSinkInputs_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, SubscribeSafeVolumeEvent_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest SubscribeSafeVolumeEvent_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, SetAvailableDeviceChangeCallback_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest SetAvailableDeviceChangeCallback_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    int32_t clientId = 0;
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, SetAvailableDeviceChangeCallback_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest SetAvailableDeviceChangeCallback_002 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    int32_t clientId = 0;
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, SetQueryClientTypeCallback_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest SetQueryClientTypeCallback_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    const sptr<IRemoteObject> object = new RemoteObjectTestStub();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, UpdateDescWhenNoBTPermission_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest UpdateDescWhenNoBTPermission_001 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, UpdateDescWhenNoBTPermission_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest UpdateDescWhenNoBTPermission_002 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    std::vector<std::shared_ptr<AudioDeviceDescriptor>> devices;
    std::shared_ptr<AudioDeviceDescriptor> desc =
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFifthUnitTest, UpdateDescWhenNoBTPermission_003, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest UpdateDescWhenNoBTPermission_003 start");
    ASSERT_NE(nullptr, GetServerPtr());
    GetPermission();
    std::vector<std::shared_ptr<AudioDeviceDescriptor>> devices;
    std::shared_ptr<AudioDeviceDescriptor> desc;
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, UpdateCapturerInfoWhenNoPermission_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest UpdateCapturerInfoWhenNoPermission_001 start");
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, UpdateCapturerInfoWhenNoPermission_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFifthUnitTest UpdateCapturerInfoWhenNoPermission_002 start");
    auto server = GetServerPtr();
    ASSERT_NE(nullptr, server);
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetPreferredOutputStreamType_002, TestSize.Level1)
{
    auto server = GetServerPtr();
    ASSERT_NE(nullptr, server) ;
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetPreferredOutputStreamType_004, TestSize.Level1){
    auto server = GetServerPtr();
    ASSERT_NE(nullptr, server) ;
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetHardwareOutputSamplingRate_001, TestSize.Level1)
{
    auto server = GetServerPtr();
    ASSERT_NE(nullptr, server);
 ...
 * @tc.desc  : Test AudioPolicyService interfaces.
 */
HWTEST_F(AudioPolicyServiceFifthUnitTest, GetProcessDeviceInfo_001, TestSize.Level1)
{
