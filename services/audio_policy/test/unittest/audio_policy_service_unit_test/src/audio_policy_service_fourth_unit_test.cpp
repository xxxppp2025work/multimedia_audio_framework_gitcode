...
HWTEST_F(AudioPolicyServiceFourthUnitTest, WaitForConnectionCompleted_001, TestSize.Level1)
{
    ...
    AudioA2dpOffloadManager audioA2dpOffloadManager_(&(AudioPolicyServiceUnitTest::GetServerPtr())->audioPolicyService_);
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, LoadSplitModule_001, TestSize.Level1)
{
    ...
    int32_t result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.LoadSplitModule(splitArgOne, networkIdOne);
    EXPECT_EQ(ERR_INVALID_PARAM, result);

    const std::string networkIdTwo = LOCAL_NETWORK_ID;
    const std::string splitArgTwo = "11.22";
    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.LoadSplitModule(splitArgTwo, networkIdTwo);
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, SetDefaultOutputDevice_001, TestSize.Level1)
{
    ...
    int32_t result =
        AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetDefaultOutputDevice(deviceType, sessionID, streamUsage, isRunning);
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, ConnectA2dpOffload_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest ConnectA2dpOffload_001 start");
    ASSERT_NE(nullptr, AudioPolicyServiceUnitTest::GetServerPtr());
    AudioA2dpOffloadManager audioA2dpOffloadManager_(&(AudioPolicyServiceUnitTest::GetServerPtr())->audioPolicyService_);
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, ConnectA2dpOffload_002, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest ConnectA2dpOffload_002 start");
    ASSERT_NE(nullptr, AudioPolicyServiceUnitTest::GetServerPtr());
    AudioA2dpOffloadManager audioA2dpOffloadManager_(&(AudioPolicyServiceUnitTest::GetServerPtr())->audioPolicyService_);
...
* @tc.desc  : Test AudioPolicyService interfaces.
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, ConnectA2dpOffload_003, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest ConnectA2dpOffload_002 start");
    ASSERT_NE(nullptr, AudioPolicyServiceUnitTest::GetServerPtr());
    AudioA2dpOffloadManager audioA2dpOffloadManager_(&(AudioPolicyServiceUnitTest::GetServerPtr())->audioPolicyService_);
...
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, GetCurActivateCount_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest GetCurActivateCount_001 start");
...
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, WriteServiceStartupError_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest WriteServiceStartupError_001 start");
    std::shared_ptr<AudioPolicyService> service = std::make_shared<AudioPolicyService>();
    ASSERT_NE(nullptr, service);
...
*/
HWTEST_F(AudioPolicyServiceFourthUnitTest, LoadToneDtmfConfig_001, TestSize.Level1)
{
    AUDIO_INFO_LOG("AudioPolicyServiceFourthUnitTest LoadToneDtmfConfig_001 start");
    std::shared_ptr<AudioPolicyService> service = std::make_shared<AudioPolicyService>();
    ASSERT_NE(nullptr, service);
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, ErasePreferredDeviceByType_001, TestSize.Level1)
{
    ...
    auto ret = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.ErasePreferredDeviceByType(preferredType);
    EXPECT_EQ(SUCCESS, ret);
}
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, DealAudioSceneOutputDevices_001, TestSize.Level1)
{
    ...
    AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.DealAudioSceneOutputDevices(audioScene, activeOutputDevices, haveArmUsbDevice);
    EXPECT_EQ(false, haveArmUsbDevice);

    const AudioScene audioScene2 = AUDIO_SCENE_VOICE_RINGING;
    haveArmUsbDevice = false;
    AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.DealAudioSceneOutputDevices(audioScene2, activeOutputDevices, haveArmUsbDevice);
    EXPECT_EQ(false, haveArmUsbDevice);

    const AudioScene audioScene3 = AUDIO_SCENE_DEFAULT;
    vector<std::unique_ptr<AudioDeviceDescriptor>> descs {};
    haveArmUsbDevice = false;
    AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.DealAudioSceneOutputDevices(audioScene3, activeOutputDevices, haveArmUsbDevice);
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, SelectRingerOrAlarmDevices_001, TestSize.Level1)
{
    ...
    bool result =AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SelectRingerOrAlarmDevices(descs1, rendererChangeInfo1);
    ...
    result =AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SelectRingerOrAlarmDevices(descs2, rendererChangeInfo2);
    ...
    AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.audioPolicyManager_.SetRingerMode(RINGER_MODE_VIBRATE);
    result =AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SelectRingerOrAlarmDevices(descs3, rendererChangeInfo3);
    EXPECT_EQ(false, result);
    ...
    AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.enableDualHalToneState_ = true;
    result =AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SelectRingerOrAlarmDevices(descs4, rendererChangeInfo4);
    EXPECT_EQ(false, result);
...
HWTEST_F(AudioPolicyServiceFourthUnitTest, SetPreferredDevice_001, TestSize.Level1)
{
    ...
    int32_t result =
        AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_MEDIA_RENDER, audioDeviceDescriptorSptr1);
    EXPECT_EQ(SUCCESS, result);

    sptr<AudioDeviceDescriptor> audioDeviceDescriptorSptr2;
    audioDeviceDescriptorSptr2->deviceType_ = DEVICE_TYPE_NONE;
    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_CALL_RENDER, audioDeviceDescriptorSptr2);
    EXPECT_EQ(SUCCESS, result);

    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_CALL_CAPTURE, audioDeviceDescriptorSptr2);
    EXPECT_EQ(SUCCESS, result);

    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_RECORD_CAPTURE, audioDeviceDescriptorSptr2);
    EXPECT_EQ(SUCCESS, result);

    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_RING_RENDER, audioDeviceDescriptorSptr2);
    EXPECT_EQ(ERR_INVALID_PARAM, result);

    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(AUDIO_TONE_RENDER, audioDeviceDescriptorSptr2);
    EXPECT_EQ(ERR_INVALID_PARAM, result);

    uint32_t preferredType = 6;
    PreferredType ERR_PFTYPE = static_cast<PreferredType>(preferredType);
    result = AudioPolicyServiceUnitTest::GetServerPtr()->audioPolicyService_.SetPreferredDevice(ERR_PFTYPE, audioDeviceDescriptorSptr2);
    EXPECT_EQ(ERR_INVALID_PARAM, result);
}
} // namespace AudioStandard
} // namespace OHOS
