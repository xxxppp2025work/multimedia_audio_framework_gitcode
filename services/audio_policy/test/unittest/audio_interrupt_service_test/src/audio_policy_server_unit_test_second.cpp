 ...
 */
HWTEST(AudioPolicyUnitTestSecond, IsStreamActiveByStreamUsage_001, TestSize.Level1)
{
    int32_t systemAbilityId = 0;
 ...
 */
HWTEST(AudioPolicyUnitTestSecond, GetVolumeInDbByStream_001, TestSize.Level1)
{
    int32_t systemAbilityId = 0;
    StreamUsage streamUsage = StreamUsage::STREAM_USAGE_MUSIC;
    int32_t volLevel = 5;
 ...
 */
HWTEST(AudioPolicyUnitTestSecond, GetSupportedAudioVolumeTypes_001, TestSize.Level1)
{
    int32_t systemAbilityId = 0;
    auto audioPolicyServer = std::make_shared<AudioPolicyServer>(systemAbilityId);
    ASSERT_NE(audioPolicyServer, nullptr);
 ...
 */
HWTEST(AudioPolicyUnitTestSecond, GetAudioVolumeTypeByStreamUsage_001, TestSize.Level1)
{
    int32_t systemAbilityId = 0;
    StreamUsage streamUsage = StreamUsage::STREAM_USAGE_MUSIC;
    auto audioPolicyServer = std::make_shared<AudioPolicyServer>(systemAbilityId);
 ...
 */
HWTEST(AudioPolicyUnitTestSecond, GetStreamUsagesByVolumeType_001, TestSize.Level1)
{
    int32_t systemAbilityId = 0;
