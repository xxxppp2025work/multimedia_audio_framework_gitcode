...
HWTEST(AudioInterruptUnitTest, AudioSessionFocusMode_003, TestSize.Level1)
{
    ...
    int32_t zoneId = -1;
    bool result = audioInterruptService->ShouldBypassAudioSessionFocus(movieInterrupt, zoneId);
    EXPECT_FALSE(result);
}
...
HWTEST(AudioInterruptUnitTest, AudioSessionFocusMode_004, TestSize.Level1)
{
    ...
    result = audioInterruptService->ShouldBypassAudioSessionFocus(movieInterrupt, zoneId);
    EXPECT_FALSE(result);
