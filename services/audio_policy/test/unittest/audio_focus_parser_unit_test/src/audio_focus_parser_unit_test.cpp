 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test LoadConfig interface.
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_002, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 * @tc.desc  : Test LoadConfig interface.
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_003, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
    EXPECT_CALL(*(mockAudioXmlNode_), Config(testing::_, testing::_, testing::_)).WillOnce(Return(SUCCESS));
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_004, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_005, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_006, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_007, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_008, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_009, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 * @tc.desc  : Test AddAllowedFocusEntry interface.it4 == forceMap.end()
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_010, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
 ...
 * @tc.desc  : Test AddAllowedFocusEntry interface.it4 == forceMap.end()
 */
HWTEST_F(AudioFocusParserUnitTest, AudioFocusParserUnitTest_011, TestSize.Level1)
{
    audioFocusParser_->curNode_ = mockAudioXmlNode_;
