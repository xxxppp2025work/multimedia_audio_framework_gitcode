...
HWTEST_F(AudioConcurrencyServiceUnitTest, AudioConcurrencyService_017, TestSize.Level1)
{
    ...
    int32_t result = audioConcurrencyService->ActivateAudioConcurrencyExt(incomingPipeType);
    ...
    result = audioConcurrencyService->ActivateAudioConcurrencyExt(incomingPipeType);
    EXPECT_EQ(audioConcurrencyService->offloadActivated_, true);
    EXPECT_EQ(result, SUCCESS);
