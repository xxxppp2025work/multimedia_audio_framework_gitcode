...
#include "audio_tone_parser_second_unit_test.h"
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_002, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_003, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_004, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_005, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_006, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_007, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_009, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_010, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_011, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 * @tc.desc  : Test Trim interface. result.empty()
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_012, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
 ...
 * @tc.desc  : Test Trim interface. result.empty()
 */
HWTEST_F(AudioToneParserSecondUnitTest, AudioToneParserSecondUnitTest_013, TestSize.Level1)
{
    EXPECT_CALL(*(mockAudioXmlNode_), IsNodeValid())
        .WillOnce(Return(true))
        .WillOnce(Return(false));
