...
public:
    ...
    MOCK_METHOD(void, OnSpatializationStateChange, (const AudioSpatializationState &spatializationState), (override));
};
...
HWTEST_F(AudioSpatializationServiceUnitTest, AudioSpatializationService_008, TestSize.Level1)
{
    ...
    EXPECT_CALL(*mockAudioSpatializationStateChangeCallback1, OnSpatializationStateChange(_)).Times(2);
    ...
    EXPECT_CALL(*mockAudioSpatializationStateChangeCallback2, OnSpatializationStateChange(_)).Times(2);
    sSpatializationService_->spatializationStateCBMap_.emplace(spatializationStateCBIndex,
        std::make_pair(mockAudioSpatializationStateChangeCallback2, StreamUsage::STREAM_USAGE_GAME));
    sSpatializationService_->HandleSpatializationStateChange(true);
    sSpatializationService_->HandleSpatializationStateChange(false);
}
