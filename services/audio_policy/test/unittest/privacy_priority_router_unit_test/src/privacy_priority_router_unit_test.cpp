 ...
 * @tc.desc  : Bluetooth SCO is disabled, connect SCO first, then connect WiredHeadset, should be selected WiredHeadset.
 */
 ...
 * @tc.desc  : Bluetooth SCO is disabled. Connect the WiredHeadset and then connect the SCO, should be selected WiredHeadset.
 */
