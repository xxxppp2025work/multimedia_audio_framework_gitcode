...
#include "../include/audio_zone_unit_test.h"
...
void AudioZoneUnitTest::SetUpTestCase(void) {}
void AudioZoneUnitTest::TearDownTestCase(void) {}
void AudioZoneUnitTest::SetUp(void) {}
