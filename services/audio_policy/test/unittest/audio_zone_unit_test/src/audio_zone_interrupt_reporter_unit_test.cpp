...
#include "../include/audio_zone_interrupt_reporter_unit_test.h"
...
/**
 * @tc.name  : Test AudioZoneInterruptReporterUnitTest.
 * @tc.number: AudioZoneInterruptReporter_003
 * @tc.desc  : Test AddAudioInterruptCallback interface.
 */
HWTEST_F(AudioZoneInterruptReporterUnitTest, AudioZoneInterruptReporter_003, TestSize.Level1)
{
    EXPECT_EQ(reporter_.GetFocusList(), {});
}
} // namespace AudioStandard
} // namespace OHOS
