...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_001, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_002, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_003, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_004, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_005, TestSize.Level1)
{
    ...
    audioPolicyServer_->CreateRendererClient(streamDesc, flag, sessionId);
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_006, TestSize.Level1)
{
    audioPolicyServer_->coreService_ = AudioCoreService::GetCoreService();
    audioPolicyServer_->coreService_->Init();
    audioPolicyServer_->eventEntry_ = audioPolicyServer_->coreService_->GetEventEntry();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_007, TestSize.Level1)
{
    audioPolicyServer_->coreService_ = AudioCoreService::GetCoreService();
    audioPolicyServer_->coreService_->Init();
    audioPolicyServer_->eventEntry_ = audioPolicyServer_->coreService_->GetEventEntry();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_008, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_009, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_010, TestSize.Level1)
{
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_011, TestSize.Level1)
{
    audioPolicyServer_->audioPolicyServerHandler_ = DelayedSingleton<AudioPolicyServerHandler>::GetInstance();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_012, TestSize.Level1)
{
    audioPolicyServer_->audioPolicyServerHandler_ = DelayedSingleton<AudioPolicyServerHandler>::GetInstance();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_013, TestSize.Level1)
{
    audioPolicyServer_->interruptService_ = std::make_shared<AudioInterruptService>();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_014, TestSize.Level1)
{
    audioPolicyServer_->coreService_ = AudioCoreService::GetCoreService();
    audioPolicyServer_->coreService_->Init();
    audioPolicyServer_->eventEntry_ = audioPolicyServer_->coreService_->GetEventEntry();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_015, TestSize.Level1)
{
    audioPolicyServer_->coreService_ = AudioCoreService::GetCoreService();
    audioPolicyServer_->coreService_->Init();
    audioPolicyServer_->eventEntry_ = audioPolicyServer_->coreService_->GetEventEntry();
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_016, TestSize.Level1)
{
    int32_t uid = 1;
    int32_t pid = 1;
...
*/
HWTEST_F(AudioPolicyServerUnitTest, AudioPolicyServer_017, TestSize.Level1)
{
    audioPolicyServer_->audioPolicyServerHandler_ = DelayedSingleton<AudioPolicyServerHandler>::GetInstance();
