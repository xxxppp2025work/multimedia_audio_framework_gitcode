...
*/
HWTEST(AudioGroupHandleUnitTest, AudioGroupHandleUnitTest_001, TestSize.Level1)
{
...
* @tc.desc  : Test CheckId.
*/
HWTEST(AudioGroupHandleUnitTest, AudioGroupHandleUnitTest_002, TestSize.Level1)
{
    AudioGroupHandle audioGroupHandleTest = AudioGroupHandle::GetInstance();
...
* @tc.desc  : Test CheckId.
*/
HWTEST(AudioGroupHandleUnitTest, AudioGroupHandleUnitTest_003, TestSize.Level1)
{
    AudioGroupHandle audioGroupHandleTest = AudioGroupHandle::GetInstance();
    GroupType type = GroupType::INTERRUPT_TYPE;
    audioGroupHandleTest.currentVolumeId_ = 1;
