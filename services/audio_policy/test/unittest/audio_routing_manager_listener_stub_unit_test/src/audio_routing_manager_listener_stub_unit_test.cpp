...
/**
 * @tc.name  : Test AudioRoutingManagerListenerStub.
 * @tc.number: AudioRoutingManagerListenerStub_004
 * @tc.desc  : Test OnRemoteRequest.
 */
HWTEST(AudioRoutingManagerListenerStubUnitTest, AudioRoutingManagerListenerStub_004, TestSize.Level1)
{
    auto audioRoutingManagerListenerStub_ = std::make_shared<AudioRoutingManagerListenerStub>();
    uint32_t code =
        IStandardAudioRoutingManagerListener::AudioRingerModeUpdateListenerMsg::ON_AUDIO_ANAHS_DEVICE_CHANGE;
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    data.WriteInterfaceToken(AudioRoutingManagerListenerStub::GetDescriptor());
