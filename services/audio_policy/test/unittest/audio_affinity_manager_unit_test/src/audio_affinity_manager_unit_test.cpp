...
const int32_t kHundred = 100;
const int32_t kTimeSpanInMillisecondsForSelection = 200;
                     ...
                     std::unordered_map<int32_t, AffinityDeviceInfo>& testDeviceInfoMap)
{
    ...
    deviceInfo1.chooseTimeStamp = kHundred;
    ...
    deviceInfo2.chooseTimeStamp = kTimeSpanInMillisecondsForSelection;
