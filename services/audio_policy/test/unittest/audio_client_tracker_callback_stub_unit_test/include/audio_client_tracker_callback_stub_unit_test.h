...
#ifndef AUDIO_CLIENT_TRACKER_CALLBACK_STUB_UNIT_TEST
...
class AudioClientTrackerCallbackStubUnitTest : public testing::Test {
public:
...
#endif // AUDIO_CLIENT_TRACKER_CALLBACK_STUB_UNIT_TEST
