 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test ~AudioPolicyStateMonitor interface.
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_002, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_003, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_004, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_005, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_006, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
 ...
 */
HWTEST_F(AudioPolicyStateMonitorUnitTest, AudioPolicyStateMonitorUnitTest_007, TestSize.Level1)
{
    std::shared_ptr<AudioPolicyStateMonitor> audioPolicyStateMonitor_ = std::make_shared<AudioPolicyStateMonitor>();
    ASSERT_TRUE(audioPolicyStateMonitor_ != nullptr);
