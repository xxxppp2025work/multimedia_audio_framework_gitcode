...
int32_t AudioPolicyProxy::BindDeviceToAudioZone(int32_t zoneId, std::vector<std::shared_ptr<AudioDeviceDescriptor>> devices)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::UnBindDeviceToAudioZone(int32_t zoneId, std::vector<std::shared_ptr<AudioDeviceDescriptor>> devices)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
