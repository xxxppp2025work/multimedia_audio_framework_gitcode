...
int32_t AudioPolicyProxy::CreateRendererClient(std::shared_ptr<AudioStreamDescriptor> streamDesc, AudioFlag &flag, uint32_t &sessionId)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::CreateCapturerClient(std::shared_ptr<AudioStreamDescriptor> streamDesc, AudioFlag &flag, uint32_t &sessionId)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
