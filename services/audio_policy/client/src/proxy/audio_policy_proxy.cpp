...
int32_t AudioPolicyProxy::NofitySessionStateChange(const int32_t uid, const int32_t pid, bool hasSession)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    ...
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, error, "NofitySessionStateChange failed, error: %{public}d", error);
    return reply.ReadInt32();
}

int32_t AudioPolicyProxy:: NotifyFreezeStateChange(const std::set<int32_t> &pidList, bool isFreeze)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
