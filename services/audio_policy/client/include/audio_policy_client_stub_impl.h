...
public:
    ...
    int32_t RemoveAppVolumeChangeForUidCallback(const int32_t appUid,
        const std::shared_ptr<AudioManagerAppVolumeChangeCallback> &cb);
    int32_t RemoveAllAppVolumeChangeForUidCallback(const int32_t appUid);
...
private:
    ...
    std::vector<std::pair<int32_t, std::shared_ptr<AudioManagerAppVolumeChangeCallback>>> appVolumeChangeForUidCallback_;
    ...
    td::map<int32_t, int32_t> selfAppVolumeChangeCallbackNum_;
