...
private:
    ...
    std::map<int32_t, std::shared_ptr<AudioManagerAppVolumeChangeCallback>> appVolumeChangeForUidCallbackMap_;
    std::map<int32_t, std::shared_ptr<AudioManagerAppVolumeChangeCallback>> selfAppVolumeChangeCallbackMap_;
