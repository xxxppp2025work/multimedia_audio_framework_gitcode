...
public:
    ...
    void ReleaseProcess(const std::string endpointName, const int32_t delayTime) override;
...
private:
    ...
    int32_t GetReleaseDelayTime(DeviceType deviceType, bool isSwitchStream);
