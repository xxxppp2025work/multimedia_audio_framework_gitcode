...
private:
    ...
    static constexpr int64_t TWO_MILLISECOND_DURATION = 1000000; // 1ms
    ...
    static constexpr int64_t WAKEUPTIME_FOR_VOIP_MMAP = 40000000; // 40ms
    static constexpr int64_t WAKEUPTIME_FOR_MMAP = 10000000; // 10ms
