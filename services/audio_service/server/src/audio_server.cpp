...
int32_t AudioServer::RestoreSession(uint32_t sessionID, const RestoreInfo &restoreInfo)
{
...
int32_t AudioServer::CreateAudioWorkgroup(int32_t pid, int32_t &workgroupId)
{
    workgroupId = audioResourceService_->CreateAudioWorkgroup(pid);
