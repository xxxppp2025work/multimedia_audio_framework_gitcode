...
int32_t AudioServer::RegisterDataTransferCallback(const int32_t &pid, const sptr<IRemoteObject> &object)
{
...
int32_t AudioServer::RegisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId,
...
int32_t AudioServer::UnregisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId)
{
    // todo: wait for add code
    return SUCCESS;
}
