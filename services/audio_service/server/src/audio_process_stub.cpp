...
int32_t AudioProcessStub::HandleSetDefaultOutputDevice(MessageParcel &data, MessageParcel &reply)
{
    ...
    reply.WriteInt32(SetDefaultOutputDevice(static_cast<OHOS::AudioStandard::DeviceType>(deviceType), sessionID,
        static_cast<OHOS::AudioStandard::StreamUsage>(streamUsage), isRunning));
    return AUDIO_OK;
}
} // namespace AudioStandard
} // namespace OHOS
