...
int32_t RendererInServer::StartInner()
{
    ...
    if (standByEnable_) {
        ...
        ret = CoreServiceHandler::GetInstance().UpdateSessionOperation(streamIndex_, SessionOperation::SESSION_OPERATION_START);
...
int32_t RendererInServer::Release()
{
    ...
    int32_t ret = CoreServiceHandler::GetInstance().UpdateSessionOperation(streamIndex_, SessionOperation::SESSION_OPERATION_RELEASE);
