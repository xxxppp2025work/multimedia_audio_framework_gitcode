...
public:
    ...
    */
     ...
     * @return result code.
     */
    virtual int32_t RegisterDataTransferCallback(const int32_t &pid, const sptr<IRemoteObject> &object) = 0;
    virtual int32_t RegisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId,
        const DataTransferMonitorParam &param) = 0;
    virtual int32_t UnregisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId) = 0;
...
public:
    ...
    virtual void OnDataTransferStateChange(const int32_t &pid,
