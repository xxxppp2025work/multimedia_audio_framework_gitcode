...
public:
    ...
    */
    ...
    virtual void SetSessionMuteState(const uint32_t sessionId, const bool muteFlag) = 0;

    virtual void OnMuteStateChange(const uint32_t sessionId, const bool muteFlag) = 0;
public:
