...
#ifndef AUDIO_WORKGROUP_CALLBACK_STUB_H
...
class AudioWorkgroupCallbackStub : public IRemoteStub<IAudioWorkgroupCallback> {
public:
...
#endif // AUDIO_WORKGROUP_CALLBACK_STUB_H
