...
public:
    ...
    void OnMuteStateChange(const uint32_t sessionId, const bool muteFlag) override;
    void SetSessionMuteState(const uint32_t sessionId, const bool muteFlag) override;
