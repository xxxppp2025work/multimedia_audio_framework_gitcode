...
int32_t FastAudioStream::SetDefaultOutputDevice(const DeviceType defaultOutputDevice, bool notSet)
{
    CHECK_AND_RETURN_RET_LOG(processClient_ != nullptr, ERR_OPERATION_FAILED, "set failed: null process");
    int32_t ret = processClient_->SetDefaultOutputDevice(defaultOutputDevice, notSet);
