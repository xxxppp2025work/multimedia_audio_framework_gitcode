...
int32_t AudioManagerProxy::RegisterDataTransferCallback(const int32_t &pid, const sptr<IRemoteObject> &object) 
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioManagerProxy::UnregisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioManagerProxy::RegisterDataTransferMonitorParam(const int32_t &pid, const int32_t &callbackId,
