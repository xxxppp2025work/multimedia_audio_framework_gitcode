...
void AudioManagerProxy::OnMuteStateChange(const uint32_t sessionId, const bool muteFlag)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
void AudioManagerProxy::SetSessionMuteState(const uint32_t sessionId, const bool muteFlag)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
