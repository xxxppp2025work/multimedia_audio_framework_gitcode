...
{
    AUDIO_INFO_LOG("WatchingCaptureInClientReadData start");
    threadStatusFlag_ = true;
    auto taskFunc = [this]() {
        if (threadStatusFlag_) {
            AUDIO_INFO_LOG("WatchingCaptureInClientReadData Set threadStatusFlag_ to false");
            threadStatusFlag_ = false;
        } else {
            AUDIO_INFO_LOG("watchdog happened, WatchingCaptureInClientReadData process exit");
        }
    };
    ...
    AUDIO_INFO_LOG("WatchingCaptureInClientReadData start %{public}d", sessionId_);
}
