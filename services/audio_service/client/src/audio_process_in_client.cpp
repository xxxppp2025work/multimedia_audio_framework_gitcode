...
public:
    ...
    int32_t Release(bool destroyAtOnce = false) override;
...
int32_t AudioProcessInClientInner::Release(bool destroyAtOnce)
{
    ...
    if (processProxy_->Release(destroyAtOnce) != SUCCESS) {
