...
nt32_t AudioSystemManager::SetSelfAppVolume(int32_t volume, int32_t flag = 0)
{
...
int32_t AudioSystemManager::SetAppVolume(int32_t appUid, int32_t volume, int32_t flag = 0)
{
...
int32_t AudioSystemManager::GetAppVolume(int32_t appUid)
{
...
int32_t AudioSystemManager::GetSelfAppVolume()
{
