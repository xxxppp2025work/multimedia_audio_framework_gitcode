 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test DirectPlayBackEngine::Init().
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_002, TestSize.Level1)
{
    DirectPlayBackEngine engine;
    AudioDeviceDescriptor deviceDesc(AudioDeviceDescriptor::DEVICE_INFO);
    bool isVoip = true;
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_003, TestSize.Level1)
{
    DirectPlayBackEngine engine;
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_004, TestSize.Level1)
{
    DirectPlayBackEngine engine;
    engine.isStart_ = true;
    uint32_t idx1 = 0;
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_005, TestSize.Level1)
{
 ...
 * @tc.desc  : Test DirectPlayBackEngine::MixStreams()
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_006, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    EXPECT_NE(enginePtr, nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_007, TestSize.Level1)
{
    DirectPlayBackEngine engine;
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_008, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    EXPECT_NE(enginePtr, nullptr);
 ...
 * @tc.desc  : Test DirectPlayBackEngine::InitSink()
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_009, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    EXPECT_NE(enginePtr, nullptr);
 ...
 * @tc.desc  : Test DirectPlayBackEngine::InitSink()
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_010, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    EXPECT_NE(enginePtr, nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_011, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
 ...
 * @tc.desc  : Test DirectPlayBackEngine::StopAudioSink()
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_012, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    ASSERT_TRUE(enginePtr != nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_013, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    EXPECT_NE(enginePtr, nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_014, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    ASSERT_TRUE(enginePtr != nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_015, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    ASSERT_TRUE(enginePtr != nullptr);
 ...
 */
HWTEST_F(DirectPlayBackEngineUnitTest, DirectPlayBackEngine_016, TestSize.Level1)
{
    auto enginePtr = std::make_shared<DirectPlayBackEngine>();
    ASSERT_TRUE(enginePtr != nullptr);
