 ...
 * @tc.name  : Test OnWriteData API
 * @tc.type  : FUNC
 * @tc.number: CheckBuffer_001
 * @tc.desc  : Test OnWriteData API when managerType_ is not PLAYBACK.
 */
HWTEST_F(RendererInServerUnitTest, CheckBuffer_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    ...
    size_t bufferSize = 0;
    int ret = rendererInServer.CheckBuffer(buffer, bufferSize);
    EXPECT_EQ(ret, false);
}
/**
 * @tc.name  : Test OnWriteData API
 * @tc.type  : FUNC
 * @tc.number: CheckBuffer_002
 * @tc.desc  : Test OnWriteData API when managerType_ is not PLAYBACK.
 */
HWTEST_F(RendererInServerUnitTest, CheckBuffer_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
 ...
 * @tc.name  : Test OnWriteData API
 * @tc.type  : FUNC
 * @tc.number: CheckBuffer_003
 * @tc.desc  : Test OnWriteData API when managerType_ is not PLAYBACK.
 */
HWTEST_F(RendererInServerUnitTest, CheckBuffer_003, TestSize.Level1)
{
    AudioProcessConfig processConfig;
...
HWTEST_F(RendererInServerUnitTest, WriteMuteDataSysEvent_002, TestSize.Level1)
{
    ...
    RendererInServer rendererInServer(processConfig, stateListener);
    rendererInServer.startMuteTime_ = 1;
    rendererInServer.silentState_ = 1;
    uint8_t buffer[10] = {0};
    size_t bufferSize = 10;
    int ret = rendererInServer.CheckBuffer(buffer, bufferSize);
    rendererInServer.WriteMuteDataSysEvent(buffer, bufferSize);
