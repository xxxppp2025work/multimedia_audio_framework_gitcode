...
HWTEST(AudioProcessInClientUnitTest, IsRestoreNeeded_001, TestSize.Level1)
{
    ...
    ptrAudioProcessInClientInner->audioBuffer_ = OHAudioBufferBase::CreateFromLocal(totalSizeInFrame, byteSizePerFrame);
    ...
    ptrAudioProcessInClientInner->WaitForBufferNeedWrite();
