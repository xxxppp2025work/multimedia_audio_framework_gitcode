...
public:
    ...
    static void S32MonoToS16Mono(std::vector<char> &audioBuffer, std::vector<char> &audioBufferConverted);
    static void S32StereoToS16Stereo(std::vector<char> &audioBuffer, std::vector<char> &audioBufferConverted);
};
} // namespace AudioStandard
} // namespace OHOS
