...
class DataTransferStaateChangeCallback {
public:
    virtual ~DataTransferStaateChangeCallback() = default;
...
public:
    ...
    void SetAudioServerPtr(DataTransferStaateChangeCallback *ptr);
private:
    AudioStreamMonitor() {}
    ~AudioStreamMonitor() {}
    ...
    DataTransferStaateChangeCallback *audioServer_ = nullptr;
};
}
}
#endif