...
struct DfxReportResult {
    ...
    std::vector<std::string> renderTimestamp{};
    std::vector<std::string> rendererStats{};
    std::vector<std::string> interruptActions{};
    std::vector<std::string> interruptTimestamp{};
    std::vector<std::string> interruptEffect{};
    std::vector<std::string> interruptInfo{};
    std::vector<std::string> capturerActions{};
    std::vector<std::string> capturerInfo{};
    std::vector<std::string> capturerTimestamp{};
    std::vector<std::string> capturerStat{};
    std::vector<std::string> appState{};
    std::vector<std::string> appStateTimestamp{};
    uint32_t summary{};
};
...
public:
    ...
    bool CheckCanAddAppInfo(uint32_t appUid);
    void Init();
    void SaveAppInfo(const DfxRunningAppInfo info);
    void UpdateAppState(uint32_t appUid, DfxAppState appstate);
private:
    DfxMsgManager();
    ...
    std::map<uint32_t, DfxRunningAppInfo> appInfo_;
