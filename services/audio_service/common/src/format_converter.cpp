...
void FormatConverter::InitS16ToFormatHandlers(FormatHandlerMap& handlers)
{
...
void FormatConverter::InitF32ToFormatHandlers(FormatHandlerMap& handlers)
{
...
void FormatConverter::InitFormatHandlers()
{
    CHECK_AND_RETURN(formatHandlers.empty());
    InitS16ToFormatHandlers(formatHandlers);
    InitF32ToFormatHandlers(formatHandlers);
}
