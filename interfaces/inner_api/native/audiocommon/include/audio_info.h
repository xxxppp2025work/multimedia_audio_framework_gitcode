...
struct VolumeEvent {
    ...
    VolumeEvent(AudioVolumeType volType, int32_t volLevel, bool isUiUpdated) :
        volumeType(volType), volume(volLevel), updateUi(isUiUpdated) {}
    VolumeEvent() = default;
...
static inline DeviceGroup GetVolumeGroupForDevice(DeviceType deviceType)
{
    static const std::map<DeviceType, DeviceGroup> DEVICE_GROUP_FOR_VOLUME = {
        ...
        {DEVICE_TYPE_NEARLINK, DEVICE_GROUP_WIRELESS}, {DEVICE_TYPE_NEARLINK, DEVICE_GROUP_WIRELESS},
    };
