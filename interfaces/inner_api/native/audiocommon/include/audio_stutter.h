...
struct AudioRendererDataTransferStateChangeInfo {
    ...
    AudioRendererDataTransferStateChangeInfo(const AudioRendererDataTransferStateChangeInfo &info)
    {
        *this = info;
    }
...
struct DataTransferMonitorParam {
    ...
    DataTransferMonitorParam(const DataTransferMonitorParam &param)
    {
        *this = param;
    }
