...
public:
    ...
    AudioDeviceDescriptor(const AudioDeviceDescriptor &deviceDescriptor)
    {
        ...
        // DeviceInfo
        isDeviceInfo_ = deviceDescriptor.isDeviceInfo_;
    ...
    bool Marshalling(Parcel &parcel) const override
    {
        ...
        if (!isDeviceInfo_ && deviceType_ == DEVICE_TYPE_USB_ARM_HEADSET) {
...
class AudioDeviceDescriptorFactory{
public:
    static sptr<AudioDeviceDescriptor> Unmarshalling(Parcel &parcel)
    {
        ...
        audioDeviceDescriptor->deviceCategory_ = static_cast<DeviceCategory>(parcel.ReadInt32());
        audioDeviceDescriptor->deviceType_ = static_cast<DeviceType>(parcel.ReadInt32());
        audioDeviceDescriptor->deviceRole_ = static_cast<DeviceRole>(parcel.ReadInt32());
        audioDeviceDescriptor->deviceId_ = parcel.ReadInt32();
        audioDeviceDescriptor->channelMasks_ = parcel.ReadInt32();
        audioDeviceDescriptor->channelIndexMasks_ = parcel.ReadInt32();
        audioDeviceDescriptor->interruptGroupId_ = parcel.ReadInt32();
        audioDeviceDescriptor->volumeGroupId_ = parcel.ReadInt32();
        audioDeviceDescriptor->deviceName_ = parcel.ReadString();
        audioDeviceDescriptor->macAddress_ = parcel.ReadString();
        audioDeviceDescriptor->networkId_ = parcel.ReadString();
        audioDeviceDescriptor->displayName_ = parcel.ReadString();
        audioDeviceDescriptor->audioStreamInfo_.Unmarshalling(parcel);
        audioDeviceDescriptor->isLowLatencyDevice_ = parcel.ReadBool();
        audioDeviceDescriptor->a2dpOffloadFlag_ = parcel.ReadInt32();
