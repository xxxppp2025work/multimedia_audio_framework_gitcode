...
public:
    ...
    static std::unordered_set<AudioVolumeType>& GetSupportedAudioVolumeTypes();
    static std::set<StreamUsage>& GetStreamUsagesByVolumeType(AudioVolumeType audioVolumeType);
