...
static bool MarshallingVAAudioStreamPropertyList(const std::list<VAAudioStreamProperty>& streamProperties, Parcel& parcel)
{
...
static void UnmarshallingVAAudioStreamPropertyList(Parcel& parcel, std::list<VAAudioStreamProperty>& streamProperties)
{
	...
	for (size_t i = 0; i < size; i++) {
		...
		streamProperty.Unmarshalling(parcel);
