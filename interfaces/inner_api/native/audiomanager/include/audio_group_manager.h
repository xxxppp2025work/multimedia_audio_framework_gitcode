...
public:
    ...
    int32_t UnsetAppVolumeCallbackForUid(const int32_t appUid,
        const std::shared_ptr<AudioManagerVolumeChangeCallback> &callback = nullptr);
    int32_t SetSelfAppVolumeCallback(const std::shared_ptr<AudioManagerVolumeChangeCallback> &callback);
    int32_t UnSetSelfAppVolumeCallback(const std::shared_ptr<AudioManagerVolumeChangeCallback> &callback = nullprt);
