...
public:
    ...
    static napi_status SetValueVolumeEvent(const napi_env& env, const VolumeEvent &volumeEvent,
        napi_value &result);
    static napi_status SetValueStreamVolumeEvent(const napi_env& env, const StreamVolumeEvent &volumeEvent,
        napi_value &result);
    static napi_status SetValueStreamUsageArray(const napi_env& env, const std::vector<StreamUsage> streamUsageArray,
        napi_value &result);
    static napi_status SetValueAudioVolumeTypeArray(const napi_env& env, const std::vector<AudioVolumeType> volumeTypeArray,
        napi_value &result);
