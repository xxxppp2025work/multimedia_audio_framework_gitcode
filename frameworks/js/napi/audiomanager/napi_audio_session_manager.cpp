...
napi_value NapiAudioSessionMgr::ActivateAudioSession(napi_env env, napi_callback_info info)
{
    ...
    if (context == nullptr) {
        ...
        NapiAudioError::ThrowError(env, "ActivateAudioSession failed : no memory", NapiAudioError::NAPI_ERR_NO_MEMORY);
...
napi_value NapiAudioSessionMgr::On(napi_env env, napi_callback_info info)
{
    ...
    CHECK_AND_RETURN_RET_LOG(
        handler == napi_function, NapiAudioError::ThrowErrorAndReturn(env, NapiAudioError::NAPI_ERR_INPUT_INVALID,
