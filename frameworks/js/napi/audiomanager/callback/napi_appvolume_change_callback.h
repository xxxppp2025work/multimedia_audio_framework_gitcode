...
public:
    ...
    void RemoveAudioVolumeChangeForUidCbRef(api_env env, napi_value callback, int32_t appUid);
    void RemoveAllAudioVolumeChangeForUidCbRef(int32_t appUid);
    void RemoveSelfAudioVolumeChangeCbRef(api_env env, napi_value callback);
...
private:
    ...
    //bool regAmSelfAppVolumeChgTsfn_ = false;
    napi_threadsafe_function amAppVolumeChgTsfn_ = nullptr;
    //napi_threadsafe_function amSelfAppVolumeChgTsfn_ = nullptr;
};
}
}
