...
void NapiRendererWriteDataCallback::OnJsRendererWriteDataCallback(std::unique_ptr<RendererWriteDataJsCallback> &jsCb)
{
    ...
    napi_create_threadsafe_function(event->callback->env_, nullptr, nullptr, cbName, 0, 1, event, WriteDataTsfnFinalize, nullptr, SafeJsCallbackWriteDataWork, &arWriteData_tsfn_);
...
void NapiRendererWriteDataCallback::SafeJsCallbackWriteDataWork(napi_env env, napi_value js_cb, void* context, void* data)
{
