...
private:
    static const int32_t CHANNEL_ONE = 0;
    static const int32_t CHANNEL_TWO = 1;
    static const int32_t CHANNEL_THREE = 2;
    static const int32_t CHANNEL_FOUR = 3;
    static const int32_t CHANNEL_FIVE = 4;
    static const int32_t CHANNEL_SIX = 5;
    static const int32_t CHANNEL_SEVEN = 6;
    static const int32_t CHANNEL_EIGHT = 7;
    template <typename T>
