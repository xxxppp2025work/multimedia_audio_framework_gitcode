...
public:
    ...
    {
        return AudioCapturer::GetSupportedFormats();
    }

    static std::vector<AudioChannel> GetSupportedChannels()
    {
        return AudioCapturer::GetSupportedChannels();
    }

    static std::vector<AudioEncodingType> GetSupportedEncodingTypes()
    {
        return AudioCapturer::GetSupportedEncodingTypes();
    }

    static std::vector<AudioSamplingRate> GetSupportedSamplingRates()
    {
        return AudioCapturer::GetSupportedSamplingRates();
    }
