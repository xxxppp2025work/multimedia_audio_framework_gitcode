...
public:
    ...
    static const sptr<IAudioPolicy> GetAudioPolicyManagerProxy(bool block = false);
...
private:
    ...
    int32_t SetClientCallbacksEnable(const CallbackChange &callbackchange, const bool &enable, bool block = false);
