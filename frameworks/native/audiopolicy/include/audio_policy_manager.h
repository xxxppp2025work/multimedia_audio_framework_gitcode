...
public:
    ...
    int32_t SetSelfAppVolumeChangeCallback(const std::shared_ptr<AudioManagerVolumeChangeCallback> &callback);

    int32_t UnsetSelfAppVolumeCallback(const std::shared_ptr<AudioManagerVolumeChangeCallback> &callback);
