...
void AudioEffectHdiParamUnitTest::SetUpTestCase(void) {
    AUDIO_INFO_LOG("AudioEffectHdiParamUnitTest: SetUpTestCase start ");
}
void AudioEffectHdiParamUnitTest::TearDownTestCase(void) {
    AUDIO_INFO_LOG("AudioEffectHdiParamUnitTest: TearDownTestCase start ");
}
void AudioEffectHdiParamUnitTest::SetUp(void) {
    AUDIO_INFO_LOG("AudioEffectHdiParamUnitTest: SetUp start ");
}
void AudioEffectHdiParamUnitTest::TearDown(void) {
    AUDIO_INFO_LOG("AudioEffectHdiParamUnitTest: TearDown start ");
}
