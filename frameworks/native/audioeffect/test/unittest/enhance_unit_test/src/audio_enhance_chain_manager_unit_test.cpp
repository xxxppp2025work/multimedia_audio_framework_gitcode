...
HWTEST_F(AudioEnhanceChainManagerUnitTest, SetAudioEnhanceProperty_001, TestSize.Level1)
{
    ...
    int32_t result = manager_->SetAudioEnhanceProperty(property);
    EXPECT_EQ(result, 0);
}
...
HWTEST_F(AudioEnhanceChainManagerUnitTest, SetAudioEnhanceProperty_002, TestSize.Level1)
{
    ...
    AudioEffectProperty property = {"record", "123", CAPTURE_EFFECT_FLAG};
    manager_->SetAudioEnhanceProperty(property);
}
...
HWTEST_F(AudioEnhanceChainManagerUnitTest, SetAudioEnhanceProperty_003, TestSize.Level1)
{
    ...
    AudioEffectProperty property = {"invalidEffect", "property1", CAPTURE_EFFECT_FLAG};
    int32_t result = manager_->SetAudioEnhanceProperty(property);
    EXPECT_EQ(result, 0);
}
...
HWTEST_F(AudioEnhanceChainManagerUnitTest, SetAudioEnhanceProperty_004, TestSize.Level1)
{
    ...
    AudioEffectProperty property = {"effect1", "property1", CAPTURE_EFFECT_FLAG};
    int32_t result = manager_->SetAudioEnhanceProperty(property);
    EXPECT_EQ(result, 0);
}
