...
int32_t AudioEnhanceChainManager::SetAudioEnhanceProperty(const AudioEffectProperty &property,
...
int32_t AudioEnhanceChainManager::SetAudioEnhancePropertyToChains(AudioEffectProperty property)
{
