    ...
    for (const auto &[scene, audioEffectChain] : sceneTypeToEffectChainMap_) {
        ...
        switch (code) {
            ...
            case HDI_FOLD_STATE:
                ...
                paramUpdated = true;
                break;
            case HDI_DEVICE_SWITCH_STATE:
                audioEffectChain->SetDeviceSwitchState(value);
                paramUpdated = true;
                break;
            default:
                break;
    ...
    const std::string &mainkey, const std::string &subkey, const std::string &value)
{
    ...
    } else if (mainkey == "device_status" && subkey == "device_switch_state") {
        updateParam(deviceSwitchState, HDI_DEVICE_SWITCH_STATE);
    } else {
