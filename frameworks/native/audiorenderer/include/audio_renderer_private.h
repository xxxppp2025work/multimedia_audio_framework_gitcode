...
public:
    RendererSwitchingInfoGuard(std::atomic<RendererSwitchingInfo> &ref, RendererSwitchingInfo initInfo)
        : rendererSwitchinfInfoRef_(ref)
    {
        ref.store(initInfo);
    }
    ...
    RendererSwitchingInfoGuard(const RendererSwitchingInfoGuard &) = delete;
    RendererSwitchingInfoGuard &operator=(const RendererSwitchingInfoGuard &) = delete;
    RendererSwitchingInfoGuard(RendererSwitchingInfoGuard &&) = delete;
    RendererSwitchingInfoGuard &operator=(RendererSwitchingInfoGuard &&) = delete;
private:
