...
class AudioAudioFormatUnsupportedErrorCallback;
...
private:
    ...
    int32_t InitAudioFormatUnsupportedErrorCallback();
    ...
    std::shared_ptr<AudioAudioFormatUnsupportedErrorCallback> AudioFormatUnsupportedErrorCallback_ = nullptr;
...
class AudioAudioFormatUnsupportedErrorCallback : public AudioFormatUnsupportedErrorCallback {
public:
    AudioAudioFormatUnsupportedErrorCallback() = default;
    virtual ~AudioAudioFormatUnsupportedErrorCallback() = default;
