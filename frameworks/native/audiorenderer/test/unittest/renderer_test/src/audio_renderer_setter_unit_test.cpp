...
HWTEST(AudioRendererUnitTest, Audio_Renderer_CheckAndRestoreAudioRenderer_001, TestSize.Level1)
{
    ...
    audioRenderer->audioStream_ = testAudioStremStub;
...
/**
* @tc.name  : Test CheckAndRestoreAudioRenderer.
* @tc.number: Audio_Renderer_CheckAndRestoreAudioRenderer_002
* @tc.desc  : Test CheckAndRestoreAudioRenderer interface.
*/
HWTEST(AudioRendererUnitTest, Audio_Renderer_CheckAndRestoreAudioRenderer_002, TestSize.Level1)
{
    AppInfo appInfo = {};
    shared_ptr<AudioRendererPrivate> audioRenderer =
        std::make_shared<AudioRendererPrivate>(STREAM_MUSIC, appInfo, true);
...
/**
* @tc.name  : Test CheckAndRestoreAudioRenderer.
* @tc.number: Audio_Renderer_CheckAndRestoreAudioRenderer_003
* @tc.desc  : Test CheckAndRestoreAudioRenderer interface.
*/
HWTEST(AudioRendererUnitTest, Audio_Renderer_CheckAndRestoreAudioRenderer_003, TestSize.Level1)
{
    AppInfo appInfo = {};
    shared_ptr<AudioRendererPrivate> audioRenderer =
        std::make_shared<AudioRendererPrivate>(STREAM_MUSIC, appInfo, true);
