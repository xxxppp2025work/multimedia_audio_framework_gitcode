...
* @tc.desc  : Test HdiRingBuffer::~HdiRingBuffer()
*/
HWTEST(HdiUtilsRingBufferUnitTest, HdiRingBuffer_001, TestSize.Level0)
{
    ...
    EXPECT_NE(ptrHdiRingBuffer, nullptr);
...
* @tc.desc  : Test HdiRingBuffer::GetRingBufferStatus()
*/
...
* @tc.desc  : Test HdiRingBuffer::GetRingBufferDataLen()
*/
...
* @tc.desc  : Test HdiRingBuffer::AcquireOutputBuffer()
*/
