...
#ifndef AUDIO_RENDER_SINK_PLUS_UNIT_TEST_H
#define AUDIO_RENDER_SINK_PLUS_UNIT_TEST_H
...
class AudioRenderSinkPlusUnitTest : public testing::Test {
public:
...
#endif // AUDIO_RENDER_SINK_PLUS_UNIT_TEST_H
