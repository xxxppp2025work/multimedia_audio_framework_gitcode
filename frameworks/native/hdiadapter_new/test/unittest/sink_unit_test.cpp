...
void SinkUnitTest::SetUpTestCase()
{
    ...
    usbRenderId_ = manager.GetId(HDI_ID_BASE_RENDER, HDI_ID_TYPE_PRIMARY, HDI_ADAPTER_ID_INFO_USB, true);
    btRenderId_ = manager.GetId(HDI_ID_BASE_RENDER, HDI_ID_TYPE_BLUETOOTH, HDI_ADAPTER_ID_INFO_DEFAULT, true);
    btMmapRenderId_ = manager.GetId(HDI_ID_BASE_RENDER, HDI_ID_TYPE_BLUETOOTH, HDI_ADAPTER_ID_INFO_MMAP, true);
