...
void SourceUnitTest::SetUpTestCase()
{
    ...
    usbCaptureId_ = manager.GetId(HDI_ID_BASE_CAPTURE, HDI_ID_TYPE_PRIMARY, HDI_ADAPTER_ID_INFO_USB, true);
    btCaptureId_ = manager.GetId(HDI_ID_BASE_CAPTURE, HDI_ID_TYPE_BLUETOOTH, HDI_ADAPTER_ID_INFO_DEFAULT, true);
