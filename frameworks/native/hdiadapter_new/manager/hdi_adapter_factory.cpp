...
{
    if (info == HDI_ADAPTER_ID_INFO_DIRECT || info == HDI_ADAPTER_ID_INFO_VOIP || info == HDI_ADAPTER_ID_INFO_DP ||
        info == HDI_ADAPTER_ID_INFO_USB) {
...
{
    if (info == HDI_ADAPTER_ID_INFO_MMAP) {
...
{
    if (info == HDI_ADAPTER_ID_INFO_USB) {
