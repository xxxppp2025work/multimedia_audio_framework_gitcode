...
void FastAudioCaptureSource::RegistStateCallback(std::unique_ptr<IAudioSourceCallback> callback)
{
    AUDIO_INFO_LOG("in");
...
int32_t FastAudioCaptureSource::PrepareMmapBuffer(void)
{
    ...
    AUDIO_INFO_LOG("memoryAddress: [%{public}p], memoryFd: [%{public}d], totalBufferFrames: [%{public}d], "
