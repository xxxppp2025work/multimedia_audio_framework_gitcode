...
void FileAudioCaptureSource::RegistCallback(IAudioSourceCallback *callback)
{
    AUDIO_INFO_LOG("not support");
}

void FileAudioCaptureSource::RegistStateCallback(std::unique_ptr<IAudioSourceCallback> callback)
{
    AUDIO_INFO_LOG("not support");
}
