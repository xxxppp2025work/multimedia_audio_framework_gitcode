...
public:
    ...
    virtual int32_t PreloadUsb(const std::string &usbInfo) SUCCESS_RET
    ...
    virtual void RegistCallback(IAudioSourceCallback *callback) {}
    virtual void RegistStateCallback(std::unique_ptr<IAudioSourceCallback> callback) {}
