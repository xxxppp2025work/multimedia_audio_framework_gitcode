...
protected:
    ...
    virtual void RegistRenderSinkCallback(uint32_t hdiRenderId, IDeviceAdapterCallback *callback) {}
    virtual void RegistCaptureSourceCallback(uint32_t hdiCaptureId, IDeviceAdapterCallback *callback) {}
