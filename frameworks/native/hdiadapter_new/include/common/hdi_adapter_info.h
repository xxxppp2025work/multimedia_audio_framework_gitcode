...
// id
enum HdiAdapterIdBase : uint32_t {
    HDI_ID_BASE_RENDER,
    HDI_ID_BASE_CAPTURE,
    HDI_ID_BASE_NUM,
};

enum HdiAdapterIdType : uint32_t {
    HDI_ID_TYPE_PRIMARY,
    HDI_ID_TYPE_FAST,
    HDI_ID_TYPE_REMOTE,
...
#define HDI_INVVALID_ID 0xFFFFFFFF

#define HDI_ADAPTER_ID_INFO_DEFAULT "default"
#define HDI_ADAPTER_ID_INFO_DIRECT "direct"
#define HDI_ADAPTER_ID_INFO_VOIP "voip"
#define HDI_ADAPTER_ID_INFO_DP "dp"
#define HDI_ADAPTER_ID_INFO_USB "usb"
#define HDI_ADAPTER_ID_INFO_EC "ec"
#define HDI_ADAPTER_ID_INFO_MIC_REF "mic_ref"
#define HDI_ADAPTER_ID_INFO_MMAP "mmap"

// device manager
enum HdiAdapterDeviceManagerType : uint32_t {
