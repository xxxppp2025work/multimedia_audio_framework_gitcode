...
int32_t ProAudioServiceAdapterImpl::AddCaptureInjector(const uint32_t &sinkPortIndex, const uint32_t &sourcePortIndex, const SourceType &sourceType)
{
    lock_guard<mutex> lock(lock_);
...
int32_t ProAudioServiceAdapterImpl::RemoveCaptureInjector(const uint32_t &sinkPortIndex, const uint32_t &sourcePortIndex, const SourceType &sourceType)
{
    lock_guard<mutex> lock(lock_);
