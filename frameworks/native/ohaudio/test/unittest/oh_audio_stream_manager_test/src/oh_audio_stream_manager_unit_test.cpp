 ...
 */
HWTEST(OHAudioRoutingManagerUnitTest, OH_AudioStreamManager_GetDirectPlaybackSupport_001, TestSize.Level0)
{
    ...
    result = OH_AudioStreamManager_GetDirectPlaybackSupport(audioStreamManager, encodingType, format, channelCount,
        samplingRate, usage, &directPlaybackMode);
 ...
 * @tc.desc  : Test OH_AudioStreamManager_GetDirectPlaybackSupport.
 */
HWTEST(OHAudioRoutingManagerUnitTest, OH_AudioStreamManager_GetDirectPlaybackSupport_002, TestSize.Level0)
{
    OH_AudioStreamManager *audioStreamManager = nullptr;
    auto result = OH_AudioManager_GetAudioStreamManager(&audioStreamManager);
    EXPECT_EQ(result, AUDIOCOMMON_RESULT_SUCCESS);
