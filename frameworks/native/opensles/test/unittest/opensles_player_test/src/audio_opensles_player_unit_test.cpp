...
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Enqueue_002, TestSize.Level0)
{
    wavFile_ = fopen(TEST_FILE_PATH, "rb");
    if (wavFile_ != nullptr) {
        SLuint8* buffer = nullptr;
...
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Clear_002, TestSize.Level0)
{
...
HWTEST(AudioOpenslesPlayerUnitTest, SetVolumeLevelAdapter_001, TestSize.Level1)
{
    SLresult result = AudioPlayerAdapter::GetInstance()->SetVolumeLevelAdapter(-1, 0);
    EXPECT_TRUE(result == SL_RESULT_RESOURCE_ERROR);
}

HWTEST(AudioOpenslesPlayerUnitTest, GetVolumeLevelAdapter_002, TestSize.Level1)
{
...
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetRecordState_001, TestSize.Level0)
{
    SLresult result = (*captureItf_)->SetRecordState(captureItf_, SL_RECORDSTATE_PAUSED);
    EXPECT_TRUE(result == SL_RESULT_SUCCESS);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetRecordState_002, TestSize.Level0)
{
    SLresult result = (*captureItf_)->SetRecordState(captureItf_, SL_RECORDSTATE_STOPPED);
    EXPECT_TRUE(result == SL_RESULT_SUCCESS);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetRecordState_003, TestSize.Level1)
{
    SLresult result = (*captureItf_)->SetRecordState(nullptr, SL_RECORDSTATE_RECORDING);
    EXPECT_TRUE(result == SL_RESULT_PARAMETER_INVALID);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetRecordState_004, TestSize.Level0)
{
    SLresult result = (*captureItf_)->SetRecordState(captureItf_, SL_RECORDSTATE_RECORDING);
    EXPECT_TRUE(result == SL_RESULT_SUCCESS);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetRecordState_002, TestSize.Level1)
{
    SLuint32 state;
...
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetRecordState_001, TestSize.Level0)
{
    SLuint32 state;
...
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetDurationLimit_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->SetDurationLimit(nullptr, 0);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetPosition_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->GetPosition(nullptr, nullptr);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}
HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_RegisterCallback_003, TestSize.Level1)
{
    SLresult result = (*captureItf_)->RegisterCallback(captureItf_, nullptr, wavFile_);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetCallbackEventsMask_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->SetCallbackEventsMask(nullptr, 0);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetCallbackEventsMask_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->GetCallbackEventsMask(nullptr, nullptr);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetMarkerPosition_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->SetMarkerPosition(nullptr, 0);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_ClearMarkerPosition_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->ClearMarkerPosition(nullptr);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetMarkerPosition_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->GetMarkerPosition(nullptr, nullptr);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_SetPositionUpdatePeriod_001, TestSize.Level1)
{
    SLresult result = (*captureItf_)->SetPositionUpdatePeriod(nullptr, 0);
    EXPECT_TRUE(result == SL_RESULT_FEATURE_UNSUPPORTED);
}

HWTEST(AudioOpenslesPlayerUnitTest, Audio_Opensles_Capture_GetPositionUpdatePeriod_001, TestSize.Level1)
{
