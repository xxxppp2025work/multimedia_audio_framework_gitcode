...
// TODO:
// func FfiMMAGetMaxAmplitudeForInputDevice(inputDevice: AudioDeviceDescriptor, errorCode: CPointer<int32_t>): Float32
// func FfiMMAGetMaxAmplitudeForOutputDevice(outputDevice: AudioDeviceDescriptor, errorCode: CPointer<int32_t>): Float32
...
FFI_EXPORT Float32 FfiMMAGetSystemVolumeInDb(int64_t id, int32_t volumeType, int32_t volumeLevel, int32_t device, int32_t *errorCode)
...
FFI_EXPORT bool FfiMMAIsMute(int64_t id, int32_t *errorCode): 
