...
static const std::map<AudioVolumeType, int32_t> ANI_AUDIO_VOLUME_TYPE_INDEX_MAP = {
    {AudioVolumeType::STREAM_VOICE_CALL, 0},
    {AudioVolumeType::STREAM_RING, 1},
    {AudioVolumeType::STREAM_MEDIA, 2},
    {AudioVolumeType::STREAM_VOICE_ASSISTANT, 3},
    {AudioVolumeType::STREAM_SYSTEM, 4},
    {AudioVolumeType::STREAM_ENFORCED_AUDIBLE, 5},
    {AudioVolumeType::STREAM_DTMF, 6},
    {AudioVolumeType::STREAM_ALL, 7}
};

static const std::map<AudioEnumAni::AudioJsVolumeType, int32_t> ANI_AUDIO_JS_VOLUME_TYPE_INDEX_MAP = {
    {AudioEnumAni::AudioJsVolumeType::VOLUMETYPE_DEFAULT, 0},
    {AudioEnumAni::AudioJsVolumeType::VOICE_CALL, 1},
    {AudioEnumAni::AudioJsVolumeType::RINGTONE, 2},
    {AudioEnumAni::AudioJsVolumeType::MEDIA, 3},
    {AudioEnumAni::AudioJsVolumeType::ALARM, 4},
    {AudioEnumAni::AudioJsVolumeType::ACCESSIBILITY, 5},
    {AudioEnumAni::AudioJsVolumeType::VOICE_ASSISTANT, 6},
    {AudioEnumAni::AudioJsVolumeType::ULTRASONIC, 7},
    {AudioEnumAni::AudioJsVolumeType::VOLUMETYPE_MAX, 8},
    {AudioEnumAni::AudioJsVolumeType::ALL, 9}
...
ani_status AudioEnumAni::EnumGetValueInt32(ani_env *env, ani_enum_item enumItem, int32_t &value)
{
    ...
    CHECK_STATUS_RET(AniParamUtils::GetInt32(env, aniInt, value), "GetInt32 failed");
    return ANI_OK;
}
...
ani_status AudioEnumAni::EnumGetValueString(ani_env *env, ani_enum_item enumItem, std::string &value)
{
    ...
    CHECK_STATUS_RET(AniParamUtils::GetString(env, aniString, value), "GetString failed");
    return ANI_OK;
}

ani_status AudioEnumAni::ToAniEnum(ani_env *env, AudioVolumeType value, ani_enum_item &aniEnumItem)
{
    CHECK_COND_RET(env != nullptr, ANI_INVALID_ARGS, "Invalid env");

    auto it = ANI_AUDIO_VOLUME_TYPE_INDEX_MAP.find(value);
    CHECK_COND_RET(it != ANI_AUDIO_VOLUME_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_AUDIO_VOLUME_TYPE.c_str(), &aniEnum), "Find Enum Fail");
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, AudioJsVolumeType value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_AUDIO_JS_VOLUME_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Error enum:%{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, InterruptHint value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_INTERRUPT_HINT_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_INTERRUPT_HINT.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, InterruptType value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_INTERRUPT_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_INTERRUPT_TYPE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, DeviceRole value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_DEVICE_ROLE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_DEVICE_ROLE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, DeviceType value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_DEVICE_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_DEVICE_TYPE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, AudioStreamDeviceChangeReason value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_AUDIO_STREAM_DEVICE_CHANGE_REASON_INDEX_MAP.end(),
        ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_AUDIO_STREAM_DEVICE_CHANGE_REASON.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, ContentType value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_CONTENT_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS, "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_CONTENT_TYPE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, StreamUsage value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_STREAM_USAGE_INDEX_MAP.end(), ANI_INVALID_ARGS,
        "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_STREAM_USAGE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, InterruptMode value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_INTERRUPT_MODE_INDEX_MAP.end(), ANI_INVALID_ARGS,
        "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_INTERRUPT_MODE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, InterruptForceType value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_INTERRUPT_FORCE_TYPE_INDEX_MAP.end(), ANI_INVALID_ARGS,
        "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);

    ani_enum aniEnum {};
    CHECK_STATUS_RET(env->FindEnum(ANI_CLASS_INTERRUPT_FORCE_TYPE.c_str(), &aniEnum), "Find Enum Fail");
    CHECK_STATUS_RET(env->Enum_GetEnumItemByIndex(aniEnum, enumIndex, &aniEnumItem), "Find Enum item Fail");
    return ANI_OK;
}
...
ani_status AudioEnumAni::ToAniEnum(ani_env *env, AudioSamplingRate value, ani_enum_item &aniEnumItem)
{
    ...
    CHECK_COND_RET(it != ANI_AUDIO_SAMPLING_RATE_INDEX_MAP.end(), ANI_INVALID_ARGS,
        "Unsupport enum: %{public}d", value);
    ani_int enumIndex = static_cast<ani_int>(it->second);
