 ...
 */
#ifndef FRAMEWORKS_ANI_SRC_INCLUDE_AUDIO_MANAGER_ANI_H
#define FRAMEWORKS_ANI_SRC_INCLUDE_AUDIO_MANAGER_ANI_H
...
public:
    ...
    static void On(ani_env *env, ani_object object, ani_string type, ani_object info, ani_object callback);
...
#endif //  FRAMEWORKS_ANI_SRC_INCLUDE_AUDIO_MANAGER_ANI_H
