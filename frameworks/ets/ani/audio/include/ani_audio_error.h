 ...
 */
#ifndef FRAMEWORKS_ANI_SRC_INCLUDE_ANI_AUDIO_ERROR_H
#define FRAMEWORKS_ANI_SRC_INCLUDE_ANI_AUDIO_ERROR_H
...
#endif // FRAMEWORKS_ANI_SRC_INCLUDE_ANI_AUDIO_ERROR_H
